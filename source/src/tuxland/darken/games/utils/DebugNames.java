...
/**
 * DebugNames - Parametrage de la classe Debug
 * @author Philippe Bousquet (Darken33@free.fr)
 *         <br/><strong>Previous :</strong> 
 *         Pascal "Toweld" Bourut (toweld@planetelibre.org) 
 * @version 0.1.0
 */
public interface DebugNames
{
	/** Les differents modes de Debug */
    public static int SHOW_ALL = 3;
    public static int SHOW_SOME = 2;
    public static int SHOW_MIN = 1;
