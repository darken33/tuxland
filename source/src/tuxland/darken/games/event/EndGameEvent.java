 ...
 */
package darken.games.event;

/**
 * AllCDRomCollected - Evenement déclanché lorsque le joueur à recolté tous les CD
 * @author Philippe Bousquet (Darken33@free.fr)
 *         <br/><strong>Previous :</strong> 
 *         Pascal "Toweld" Bourut (toweld@planetelibre.org) 
 * @version 0.1.0
 */
public class EndGameEvent extends Throwable
{   
	private boolean success;
	
    public EndGameEvent(boolean success)
    {
  	  super();
